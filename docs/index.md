...
- 🩺 **[Salud](salud/index.md)** — artículos sobre salud, primeros auxilios, botiquines, hábitos y todo lo relacionado con el bienestar y la prevención.
- 🧰 **[Utilidades](utilidades/index.md)** — herramientas, trucos y recursos prácticos que facilitan tareas del día a día (conversión de formatos, organización, etc.).
